    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/ma')) {
            ...
            if (0 === strpos($pathinfo, '/maquette')) {
                ...
                // Contact
                if ($pathinfo === '/maquette/contact') {
                    return array (  '_controller' => 'PaT\\MaquetteBundle\\Controller\\MaquetteController::contactAction',  '_route' => 'Contact',);
                }
        ...
        if (0 === strpos($pathinfo, '/log')) {
            if (0 === strpos($pathinfo, '/login')) {
                // login
                if ($pathinfo === '/login') {
                    return array (  '_controller' => 'PaT\\UserBundle\\Controller\\SecurityController::loginAction',  '_route' => 'login',);
                }
